...
// T&C Sub Types
type TCSubType : String(30) enum {
    CUSTOMER_PORTFOLIO_TERMS;
    MARKETPLACE_TERMS_OF_USE;
    POTAC;
};

// Version Status
type VersionStatus : String(20) enum { ACTIVE; ARCHIVED; };

// User Action
type ActionStatus : String(20) enum { ACCEPTED; DECLINED; };
...
entity TCActionLog : cuid {
    ...
    firstName      : String(60);
    lastName       : String(60);
    userProfile    : String(20) enum { CUSTOMER; SUPPLIER; HP_USER } not null;
    tcType         : TCType not null;
    tcSubType      : TCSubType not null;
...
entity ChangeLog : cuid {
    ...
    actionType     : String(30) enum { UPLOAD_TC; ARCHIVE_TC; } not null;
    tcType         : TCType not null;
    tcSubType      : TCSubType not null;
    versionNumber  : String(20) not null;
